...
let add_primitives job scope =
  Array.iter (fun (n, p) -> bind_primitive scope n p)
    [| ("ps_get_global", PrimitiveN (3, ps_get_global));
       ...
       ("ps_stroke", Primitive2 (ps_draw "ps_stroke" `Stroke));
       ("ps_fill", Primitive2 (ps_draw "ps_fill" `Fill));
       ("ps_clip", Primitive2 (ps_draw "ps_clip" `Clip));
