...
The file \cs{page-layout.tex} contains two predefined page layouts and a
...
The file \cs{references.tex} provides an implementation of
...
The file \cs{references.tex} also provides the following two commands
\begin{code}
  \cs{\currentpage}
