...
val glyph_to_bitmap        : glyph_slot -> (int * int * Bitmap.bitmap)
val ft_set_char_size       : face -> num -> int -> unit
val ft_get_glyph           : face -> int -> glyph_slot

val ft_load_default       : int
val ft_load_no_scale      : int
val ft_load_no_hinting    : int
val ft_load_render        : int
val ft_load_monochrome    : int
val ft_load_linear_design : int
val ft_kerning_default    : int
val ft_kerning_unfitted   : int
val ft_kerning_unscaled   : int
